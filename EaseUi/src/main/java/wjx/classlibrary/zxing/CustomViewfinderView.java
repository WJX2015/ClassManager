...
public class CustomViewfinderView extends ViewfinderView {
    ...
    public int[] colors=new int[]{0xffffff00,0xffffff00,0xffffff00};
    ...
    public void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#ffff8800"));//定义画笔的颜色
        ...
        if (resultBitmap != null) {
            ...
            //绘制扫描线
            canvas.drawRect(frame.left + 10, frame.top+laserLinePosition , frame.right -10 , frame.top +10+laserLinePosition, paint);
